...
def document_structurization_example(image):
    ...
    layout_analysis_configs['model_path'] = '/home/softbd/workstation/own/python/bangla-doc-parser/models/DocXLayout_231012.pth'  # note that: currently the layout analysis model is NOT from modelscope
